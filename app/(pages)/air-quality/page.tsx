      ...
      <section className="relative flex w-full flex-col">
        ...
        <TextBlock align="left">
          <div className="desktop:mt-40 mt-22.5 desktop:pl-25 desktop:pr-[30px] tablet-portrait:px-12 flex w-full flex-1 flex-grow flex-col px-6">
            ...
            <div className="desktop:flex-row desktop:mb-0 mb-9 flex w-full flex-col items-center justify-center gap-9">
              <div className="desktop:w-4/12 flex w-full flex-col">
                {greenhouseEmissions.map(({ name, value, color }, index) => (
                    ...
                    <div className="flex gap-x-4">
                      <div
                        ...
                        style={{
                          ...
                          border:
                            color === '#FFFFFF' ? '#0A215B 1px solid' : 'none',
                        }}
                      >
                        &nbsp;
                      </div>
              ...
              <div className="border-dark-blue desktop:w-8/12 flex w-full flex-col items-center justify-center rounded-[20px] border bg-white p-5">
                <PieChart width={530} height={500}>
                  <Pie
                    data={greenhouseEmissions}
                    cx="50%"
                    cy="50%"
                    labelLine={false}
                    ...
                    startAngle={-270}
                  >
                    {greenhouseEmissions.reverse().map((entry, index) => (
                      <Cell
                        stroke="#000000"
            ...
            <div className="desktop:flex-row desktop:m-0 mb-9 flex w-full flex-col items-center justify-center gap-9">
              <div className="desktop:w-4/12 flex w-full flex-col">
                {particulatePollution.map(({ name, value, color }, index) => (
                  <div className="border-dark-blue text-dark-gray flex w-full items-center justify-between border-b py-2">
                    <div className="flex gap-x-4">
                      <div
                        className="block h-7 w-7"
              ...
              <div className="border-dark-blue desktop:w-8/12 flex w-full flex-col items-center justify-center rounded-[20px] border bg-white p-5">
                <PieChart width={530} height={400}>
                  <Pie
                    ...
                    startAngle={-270}
                  >
                    {particulatePollution.reverse().map((entry, index) => (
                      <Cell
                        stroke="#000000"
                        key={`cell-${index}`}
                        fill={entry.color}
            ...
            <div className="desktop:flex-row desktop:m-0 mb-9 flex w-full flex-col items-center justify-center gap-9">
              <div className="desktop:w-4/12 flex w-full flex-col">
                {nitrogenOxidePollution.map(({ name, value, color }, index) => (
                  <div className="border-dark-blue text-dark-gray flex w-full items-center justify-between border-b py-2">
                    <div className="flex gap-x-4">
                      <div
                        className="block h-7 w-7"
              ...
              <div className="border-dark-blue desktop:w-8/12 flex w-full flex-col items-center justify-center rounded-[20px] border bg-white p-5">
                <PieChart width={530} height={400}>
                  <Pie
                    ...
                    startAngle={-270}
                  >
                    {nitrogenOxidePollution.reverse().map((entry, index) => (
                      <Cell
                        stroke="#000000"
                        key={`cell-${index}`}
                        fill={entry.color}
